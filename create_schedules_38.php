...
*/
  ...
  mysql_query($query1);
	...
	for($j = 7; $j <= 19; $j++) {
		if($j != 7) {
			$query2 = "INSERT INTO schedules_weekday (route_id, time) VALUES (121, '2000-01-01 ". $j . ":03:00"."')";
			mysql_query($query2);
		}
		
		$query3 = "INSERT INTO schedules_weekday (route_id, time) VALUES (121, '2000-01-01 ". $j . ":23:0"."')";
		mysql_query($query3);
		
		if($j != 19) {
			$query4 = "INSERT INTO schedules_weekday (route_id, time) VALUES (121, '2000-01-01 ". $j . ":43:00"."')";
			mysql_query($query4);
		}
	}
	$query5 = "INSERT INTO schedules_weekday (route_id, time) VALUES (121, '2000-01-01 ". "20:23:00"."')";
	mysql_query($query5);
	$query6 = "INSERT INTO schedules_weekday (route_id, time) VALUES (121, '2000-01-01 ". "21:22:00"."')";
	mysql_query($query6);
	$query7 = "INSERT INTO schedules_weekday (route_id, time) VALUES (121, '2000-01-01 ". "21:38:00"."')";
	mysql_query($query7);
