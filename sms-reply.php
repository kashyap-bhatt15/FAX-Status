...
*/
        ...
        if(array_key_exists(0, $route_details) && $route_details[0] == '0') {
            $message = "Please enter correct bus stop to get information. Check your bus stop where you at. - Developed By Kashap Bhatt";
        }
        elseif (array_key_exists(0, $route_details) && $route_details[0] == '-1') {
            $message = "System is not working because of technical reasons. Please check back later. - Developed By Kashap Bhatt";
        }
        else {
            ...
            $message = "You are at " . $stop_name . " and your next bus will be " . $bus_number . " " . $bus_direction . " and your schedule information system will be up soon. - Developed By Kashap Bhatt";
        }
    }
    else {
        ...
        */
        $message .= " In order to receive your bus schedule you need to send the bus code via SMS. - Developed By Kashap Bhatt";
    }
    mysql_close($con);
